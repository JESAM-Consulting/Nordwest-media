...
const Tab04 = () => {
  return (
    <div className=" w-[96%] pl-10 pt-2 text-[#4B4B4B] ">
      <div className="font-tahoma text-[1.2rem] font-bold">
        <span className="underline underline-offset-4 ">Datens</span>
        <span className="">chutz</span>
      </div>
      <div className="font-tahoma text-[0.9rem] font-bold pt-8">
      ...
      <br />
      <br />
      Informationen zur Behandlung Ihrer Daten auf den Social Media Angeboten
      finden Sie in der Daten­schut­zerklärung für Social Media.
      <br />
      <div className="font-tahoma text-[1rem]  pt-8">
      ...
      zu erhalten. Sie haben außerdem ein Recht, die Berichtigung oder Löschung
      ...
      <br />
       ...
       nwm nordwest-media Servicegesellschaft der Sparkasse in Bremen mbH 
       <br />
      
       Geschäftsführer: Torsten Grabendorff 
       <br />
       ...
       <br />
        ...
        Telefon: +49 (0) 421-179-4444  <br />      
        E-Mail: +49 (0) 421-179-4411  <br />
      <br/>
      ...
      verarbeiten wir Ihre personenbezogenen Daten auf Grundlage von Art. 6 Abs.
      ...
      <br/>
      nwm nordwest-media Servicegesellschaft der Sparkasse Bremen mbH
      <br/>
       ...
       <br/>
        ...
        <br/>
      Telefon: +49 (0) 421-179-4444 <br/>
       E-Mail: datenschutz@telefon-held.de
       <br/>
       <br/>
      ...
      datenschutzrechtlich nicht sicheren Drittstaaten. Wenn diese Tools aktiv
      sind, können Ihre personenbezogene Daten in diese Drittstaaten übertragen
      und dort verarbeitet werden. Wir weisen darauf hin, dass in diesen Ländern
      ...
      befindlichen Daten zu Überwachungszwecken verarbeiten, auswerten und
      ...
      ODER F DSGVO ERFOLGT, HABEN SIE JEDERZEIT DAS RECHT, AUS GRÜNDEN, DIE SICH
      ...
      den Zweck der Datenverarbeitung und ggf. ein  
      ...
      Verarbeitung Ihrer personenbezogenen Daten zu verlangen. Hierzu können Sie
      sich jederzeit an uns wenden. Das Recht auf Einschränkung der Verarbeitung
      ...
      Cookies) auf Ihrem Endgerät gespeichert. Session-Cookies werden nach Ende
      Ihres Besuchs automatisch gelöscht. Permanente Cookies bleiben auf Ihrem
      Endgerät gespeichert, bis Sie diese selbst löschen oder eine automatische
      ...
      Seite betreten (Third-Party-Cookies). Diese ermöglichen uns oder Ihnen die
      Nutzung bestimmter Dienstleistungen des Drittunternehmens (z. B. Cookies
      zur Abwicklung von Zahlungsdienstleistungen).
      <br/>
      <br/>
       Cookies haben verschiedene
      ...
      oder zu Analysezwecken eingesetzt werden, werden wir Sie hierüber im
      Rahmen dieser Datenschutzerklärung gesondert informieren und ggf. eine
      ...
      <br/>
       ...
       <br/>
        Unsere Website
      nutzt die Consent-Technologie von ConsentManager, um Ihre Einwilligung zur
      Speicherung bestimmter Cookies auf Ihrem Endgerät oder zum Einsatz
      bestimmter Technologien einzuholen und diese datenschutzkonform zu
      dokumentieren. Anbieter dieser Technologie ist die Jaohawi AB,
      Håltegelvägen 1b, 72348 Västerås, Schweden, Website:
      https://www.consentmanager.de (im Folgenden „ConsentManager“).
      
      <br/>
      <br/>
       Wenn Sie
      unsere Website betreten, wird eine Verbindung zu den Servern von
      ConsentManager hergestellt, um Ihre Einwilligungen und sonstigen
      Erklärungen zur Cookie-Nutzung einzuholen. Anschließend speichert
      ConsentManager ein Cookie in Ihrem Browser, um Ihnen die erteilten
      ...
      Consent-Manager-Provider-Cookie selbst löschen oder der Zweck für die
      Datenspeicherung entfällt. Zwingende gesetzliche Aufbewahrungspflichten
      bleiben unberührt.
      <br/>
      <br/>
       Der Einsatz von ConsentManager erfolgt, um die
      ...
      Anliegens bei uns gespeichert und verarbeitet. Diese Daten geben wir nicht
      ...
      effektiven Bearbeitung der an uns gerichteten Anfragen (Art. 6 Abs. 1 lit.
      f DSGVO) oder auf Ihrer Einwilligung (Art. 6 Abs. 1 lit. a DSGVO) sofern
      ...
      der Websitebesucher zu analysieren. Hierbei erhält der Websitebetreiber
      ...
      dem jeweiligen Endgerät des Users zugeordnet. Eine Zuordnung zu einer
      Geräte-ID erfolgt nicht. 
      <br/>
      <br/>
      
      Des Weiteren können wir mit Google Analytics u.
      a. Ihre Maus- und Scrollbewegungen und Klicks aufzeichnen. Ferner
      verwendet Google Analytics verschiedene Modellierungsansätze, um die
      erfassten Datensätze zu ergänzen und setzt Machine-Learning-Technologien
      ...
      erfassten Informationen über die Benutzung dieser Website werden in der
...
<br/>      <br/>
      ...
      über ein Google-Konto verfügen, werden die Besucherdaten von Google-Signal
      mit Ihrem Google-Konto verknüpft und für personalisierte Werbebotschaften
      ...
      deutschen Datenschutzbehörden bei der Nutzung von Google Analytics
      vollständig um.
      <br/>
      ...
      Websitebesucher zur Verbesserung seiner Online-Marketing-Kampagnen
      analysieren. Hierbei werden Informationen, wie zum Beispiel die getätigten
      Bestellungen, durchschnittliche Bestellwerte, Versandkosten und die Zeit
      von der Ansicht bis zum Kauf eines Produktes erfasst. Diese Daten können
      von Google unter einer Transaktions-ID zusammengefasst werden, die dem
      ...
      bereitgestellt werden. Die Google Fonts sind lokal installiert. Eine
      ...
      <br/>
      <br/>
       Wir haben Wordfence auf dieser
      Website eingebunden. Anbieter ist Defiant Inc., Defiant, Inc., 800 5th Ave
      Ste 4100, Seattle, WA 98104, USA (nachfolgend „Wordfence“). 
      
      <br/>
      <br/>
      Wordfence
      dient dem Schutz unserer Website vor unerwünschten Zugriffen oder
      bösartigen Cyberattacken. Zu diesem Zweck stellt unsere Website eine
      dauerhafte Verbindung zu den Servern von Wordfence her, damit Wordfence
      seine Datenbanken mit den auf unserer Website getätigten Zugriffen
      ...
      berechtigtes Interesse an einem möglichst effektiven Schutz seiner Website
      vor Cyberattacken. Sofern eine entsprechende Einwilligung abgefragt wurde,
